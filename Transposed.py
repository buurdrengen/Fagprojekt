...
#     filenameM = images + '\\' + filename[0:-6] + '.jpg'
...
for filename in os.listdir(files_T):
    ...
    if filename[0:-6] == "20200220_221521":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
            f.readline()
            marginX = int(f.readline()[0:-1])
            conversion = np.float64(f.readline()[0:-1])
        blox = np.int32(np.round(np.linspace(0,2*marginX,4)))
        for i in range(3):
            sections[i] = (blox[i] + blox[i+1])/2 * conversion
        ax1.scatter(sections, L, c = 'k')
        ax1.errorbar(sections, L, sigma, ls = 'none', c='k')
    if filename[0:-6] == "20200220_223734":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
        ...
        ax1.scatter(sections, L, c = 'k')
        ax1.errorbar(sections, L, sigma, ls = 'none', c='k')
    if filename[0:-6] == "20200220_225515":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
        ...
        ax1.scatter(sections, L, c = 'k')
        ax1.errorbar(sections, L, sigma, ls = 'none', c='k')
    if filename[0:-6] == "20200220_231318":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
    ...
    if filename[0:-6] == "20200206_094159":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
    ...
    if filename[0:-6] == "20200206_101354":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
        ...
        ax2.scatter(sections, L, c = 'k')
        ax2.errorbar(sections, L, sigma, ls = 'none', c='k')
    if filename[0:-6] == "20200206_103511":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
    ...
    if filename[0:-6] == "20200122_215146":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
    ...
    if filename[0:-6] == "20200122_221025":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
        ...
        ax3.scatter(sections, L, c = 'k')
        ax3.errorbar(sections, L, sigma, ls = 'none', c='k')
    if filename[0:-6] == "20200122_222713":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
    ...
    if filename[0:-6] == "20200219_135306":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
    ...
    if filename[0:-6] == "20200219_141939":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
        ...
        ax4.scatter(sections, L, c = 'k')
        ax4.errorbar(sections, L, sigma, ls = 'none', c='k')
    if filename[0:-6] == "20200219_143636":
        imagePlacement = os.getcwd() + '\\variables\\' + filename[0:-6] + '.txt'
        with open(imagePlacement, 'r') as f:
            f.readline()
            f.readline()
...
fig.savefig('errorDepth_T')


plt.close()
fig = plt.figure(1)
plt.title('RMSE vertical')
plt.hist([RMSE_exp_all, RMSE_gauss_all, RMSE_xpow_all, RMSE_xexp_all], stacked = True, range = (0,0.07), bins=20, density=True)
